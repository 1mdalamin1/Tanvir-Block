...
return array(
	...
	'my-icon-img' => array(
		...
		'attributes' => array(
			...
			'switch_hide_title' => array(
				'type' => 'boolean',
				'default' => false
			),
			'alignment_text' => array(
				'type' => 'string',
				'default' => 'left'
			),
			'titletext' => array(
				'type' => 'string',
				'selector' => '.tanvir-block-title',
				'default' => '24/7 Emergency Response',
				'source' => 'html'
			)
		),
		'supports' => array(
	...
	'my-img-box' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'tanvir-blocks/my-img-box',
		'version' => '0.1.0',
		'title' => 'My Image Box',
		'category' => 'tanvirblocks',
		'icon' => 'superhero',
		'description' => 'My Image Box is a block scaffolded with Create Block tool.',
		'example' => array(
		...
		'attributes' => array(
			...
			'descriptiontext' => array(
				'type' => 'string',
				'selector' => 'p',
				'default' => 'Advanced technology to find and fix leaks quickly',
				'source' => 'html'
			),
			'list_id' => array(
				'type' => 'string',
